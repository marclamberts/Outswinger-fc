...
def load_and_process_data(selected_league, selected_metric_key):
    ...
    data_config = {
        "WSL": {
            ...
            'Expected Disruption (xDisruption)': {"file": "WSL_xDisruption.csv", "cols": ['Player', 'Team', 'ActualDisruptions', 'ExpectedDisruptions'], "sort": 'ExpectedDisruptions'}
        },
        "WSL 2": {
            ...
            'Expected Disruption (xDisruption)': {"file": "WSL2_xDisruption.csv", "cols": ['Player', 'Team', 'ActualDisruptions', 'ExpectedDisruptions'], "sort": 'ExpectedDisruptions'}
        },
        "Frauen-Bundesliga": {
            ...
            'Expected Disruption (xDisruption)': {"file": "FBL_xDisruption.csv", "cols": ['Player', 'Team', 'ActualDisruptions', 'ExpectedDisruptions'], "sort": 'ExpectedDisruptions'}
        }
    }
