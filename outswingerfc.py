...
def main():
    ...
    data_config = {
        "WSL": {
            ...
            'Expected Disruption (xDisruption)': {"file": "WSL_xDisruption.csv", "cols": ['playerName', 'Team', 'ActualDisruption', 'ExpectedDisruptions'], "sort": 'ExpectedDisruptions'}
        },
        "WSL 2": {
            ...
            'Expected Disruption (xDisruption)': {"file": "WSL2_xDisruption.csv", "cols": ['playerName', 'Team', 'ActualDisruption', 'ExpectedDisruptions'], "sort": 'ExpectedDisruptions'}
        }
    }
